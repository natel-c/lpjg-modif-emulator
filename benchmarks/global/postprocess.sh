...
gmapall lai1961to1990.txt -P lai_ -legend common/legend_lai_global.txt -portrait $GMAPSMOOTH -vert
describe_images "LAI For All PFTs (1961-90 average). Units: m2 m-2"  lai_*.jpg

gmapall cmass1961to1990.txt -P cmass_ -legend common/legend_cmass_global.txt -portrait $GMAPSMOOTH -vert
describe_images "CMASS For All PFTs (1961-90 average). Units: kgC m-2" cmass_*.jpg

gmapall cton_leaf1961to1990.txt -P cton_leaf_ -legend common/legend_cton.txt -portrait $GMAPSMOOTH -vert
...
gmap lai1961to1990max.txt -t 'Dominant PFT (greatest LAI)' -lon 1 -lat 2 -i 3 -legend legend_global.txt -portrait -o maxLAI.jpg -pixoffset 0.0 0.0 $GMAPPIXELSIZE -vert
...
gmap biomes_lai1961to1990.txt -t 'Biomes (Smith et al. 2014)' -lon 1 -lat 2 -i 3 -legend legend_biomes.txt -portrait -o biomes.jpg -pixoffset 0.0 0.0 $GMAPPIXELSIZE -vert
describe_image biomes.jpg "Biomes in Each Gridcell (1961-90 average) (according to Smith et al. 2014)"
...
gmap aiso1961to1990.txt -t 'Isoprene flux (mg C/m2/y)' -legend legend_bvoc_global.txt -portrait -lon 1 -lat 2 -i 'Total' -o aiso_tot.jpg -pixoffset 0.0 0.0 $GMAPSMOOTH -vert
gmap amon1961to1990.txt -t 'Monoterpene flux (mg C/m2/y)' -legend legend_bvoc_global.txt -portrait -lon 1 -lat 2 -i 'Total' -o amon_tot.jpg -pixoffset 0.0 0.0 $GMAPSMOOTH -vert
